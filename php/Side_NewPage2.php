...
<head>
    ...
    <link rel="StyleSheet" href="../blog_CSS/NewPage.css">
    <title>Terra Sea</title>
</head>

<body>
    <div class="sidenavi_midashi">最近の記事</div><br>
    <?php
        ...
        if ($link) {
            ...
            $query = 'SELECT url, title FROM `recent_article` ORDER BY date DESC LIMIT 5';
