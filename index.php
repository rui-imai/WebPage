        ...
        <div class="wrap">
            <div id="contents">
                ...
                <div class="kiji">
                    ...
                    ちょっとゆるめの記事はこちら&darr;<br>
                    <a href="https://terrasea.jp/blog.php" target="_blank" style="color:#FFF;"><span class="link_buttom">&#034;terrasea.jp/blog&#034;へ&#033;</span></a><br>
                ...
                <?php
                    ...
                    if ($link) {
                        ...
                        $query = 'SELECT id,url, title, thumbnail, split_date FROM `recent_article` ORDER BY date DESC limit 10 ' ;
                ...
                <div class="kiji" style="text-align:center;"><strong>
                    <a href="archive.php"class="link_buttom">過去のアーカイブはこちら</a>
                     </strong>
                </div><br>
